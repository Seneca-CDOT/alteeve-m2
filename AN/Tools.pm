...
sub _set_defaults
{
	...
	$an->data->{sys}{os_variant}                           = [
		"rhel7#!#Red Hat Enterprise Linux 8",
		...
		"rhel7#!#Ubuntu 17.10 (Artful Aardvark)",
		"rhel7#!#Ubuntu 17.04 (Zesty Zapus)",
		"rhel7#!#Ubuntu 16.10 (Yakkety Yak)",
		"rhel7#!#Ubuntu 16.04 LTS (Xenial Xerus)",
		"rhel7#!#Ubuntu 15.10 (Wily Werewolf)",
		"rhel7#!#Ubuntu 15.04 (Vivid Vervet)",
		"rhel7#!#Ubuntu 14.10 (Utopic Unicorn)",
